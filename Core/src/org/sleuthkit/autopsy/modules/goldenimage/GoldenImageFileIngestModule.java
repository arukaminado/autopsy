 ...
 */
class GoldenImageFileIngestModule implements FileIngestModule {
    ...
    private final boolean skipKnownFiles = false;
    private IngestJobContext context = null;
    private static final IngestModuleReferenceCounter refCounter = new IngestModuleReferenceCounter();

    GoldenImageFileIngestModule(GoldenImageModuleIngestJobSettings settings) {
    ...
    public IngestModule.ProcessResult process(AbstractFile file) {
        ...
        try {
            ...
            BlackboardAttribute attr = new BlackboardAttribute(attrType, GoldenImageIngestModuleFactory.getModuleName(), count);
            ...
            ModuleDataEvent event = new ModuleDataEvent(GoldenImageIngestModuleFactory.getModuleName(), ARTIFACT_TYPE.TSK_GEN_INFO);
            ...
            Logger logger = ingestServices.getLogger(GoldenImageIngestModuleFactory.getModuleName());
